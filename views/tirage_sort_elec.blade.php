...
@section('content')
        ...
        <div class="main_content">
            ...
            <div class="filtre row">
                ...
                <div class="row g-3 mt-0 mb-4" style="width:100%; justify-content: space-between;">
    
                    <div class="col-md-5 pr-0">
                      <div class="input-group">
                       
                          <select class="selectpicker pick_dist">
                            <option selected class='d-none'>Distributeur</option>
                      ...
                      <span class="float-right nbr_participant">Nombre de participant par ville</span>
                      
                    </div>
                  
                    <div class="col-md-3 pr-0">
                        <select class="selectpicker pick100">
                            <option selected class='d-none'>Gain</option>
                            <option value="1">One</option>
                            <option value="2">Two</option>
                            <option value="3">Three</option>
                        </select>
                    ...
                    <div class="col-md-3 pr-0">
                        <select class="selectpicker pick100">
                            <option selected class='d-none'>Classement</option>
                            <option value="1">One</option>
                            <option value="2">Two</option>
                            <option value="3">Three</option>
                        </select>
